package com.dyllanriffo.prueba3androiddr;
...
public class MyArrayAdapter<U> extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            vHolder.Nombre = view.findViewById(R.id.Nombre);
            vHolder.Valor = view.findViewById(R.id.Valor);
        ...
        vHolder.Nombre.setText(u.getNombreSensor());
        vHolder.Valor.setText(u.getValorSensor());
        return view;
    }
